...
REST_API_URL = "https://localhost:5000/predict"
...
def image_request(IMAGE_PATH, save_images, destination_path, compare_images):
    ...
    # submit the request
    r = requests.post(REST_API_URL, files=payload, verify='/Users/Chris/PycharmProjects/RestfulWebService/cert/cert.pem').json()
    #
    #
